          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <div className="lg:col-span-7 space-y-8 relative">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                <div>
                  <span className="text-foreground">First Rule:</span>
                </div>
                <div>
                  <span className="text-primary">Train Like Hell</span>
                </div>
                <div className="pt-2">
                ...
                <div className="pt-2">
                  ...
                  <span className="text-primary"> Tylers AI</span>
                </div>
              </h1>
              ...
              Youre one diet and one workout plan away from the real you. Tyler will show you how
              </p>
